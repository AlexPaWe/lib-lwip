...
#define DNS_LOCAL_HOST_LIST CONFIG_LWIP_DNS_LOCAL_HOST_LIST /* default 1 */
#define DNS_LOCAL_HOSTLIST_IS_DYNAMIC CONFIG_LWIP_DNS_LOCAL_HOSTLIST_IS_DYNAMIC /* default 1 */
#endif /* LWIP_DNS */
